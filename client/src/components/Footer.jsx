    ...
    <div className="footer">
      ...
      <div className="footerMid">
        <div className="footerMid1">
          ...
          <p className="footerMid1-4">0800-343-2110</p>
          <p className="footerMid1-5">Customers_support@mreats.com</p>
        </div>
        <div className="footerMid2">
          <p className="footerMidHead">OUR COMPANY</p>
          <p className="footerMid2-1">
            <span>Address:</span> Opposit palm mall, tanke, ilorin, kwara state
          </p>
      ...
      <div className="footerButtom">
        ...
        <div className="footerButtom2">
          <p>
            Copyright © 2024 <span>Mreats</span>. All Rights Reserved.
          </p>
